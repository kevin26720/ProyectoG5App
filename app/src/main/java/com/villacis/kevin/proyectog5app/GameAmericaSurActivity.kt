...
class GameAmericaSurActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        enableEdgeToEdge()
        setContentView(R.layout.activity_game_america_sur)

        val interactiveMap = findViewById<InteractiveMapView>(R.id.ivMap)
        interactiveMap.loadMap(R.drawable.sura)

        configurarBandera(R.id.flagItem1, "chile", R.drawable.chile)
        configurarBandera(R.id.flagItem2, "ecuador", R.drawable.ecuador)
        configurarBandera(R.id.flagItem3, "argentina", R.drawable.argentina)
        configurarBandera(R.id.flagItem4, "colombia", R.drawable.colombia)
        configurarBandera(R.id.flagItem5, "bolivia", R.drawable.bolivia)
        configurarBandera(R.id.flagItem6, "peru", R.drawable.peru)
        configurarBandera(R.id.flagItem7, "uruguay", R.drawable.uruguay)
        configurarBandera(R.id.flagItem8, "paraguay", R.drawable.paraguay)
        configurarBandera(R.id.flagItem9, "venezuela", R.drawable.venezuela)
        configurarBandera(R.id.flagItem10, "brasil", R.drawable.brasil)
