...
class GameAmericaNorteActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_game_america_norte)

        val interactiveMap = findViewById<InteractiveMapView>(R.id.ivMap)
        interactiveMap.loadMap(R.drawable.na)

        configurarBandera(R.id.flagItem1, "estados_unidos", R.drawable.estados_unidos)
        configurarBandera(R.id.flagItem2, "canada", R.drawable.canada)
        configurarBandera(R.id.flagItem3, "mexico", R.drawable.mexico)
        configurarBandera(R.id.flagItem4, "nicaragua", R.drawable.nicaragua)
        configurarBandera(R.id.flagItem5, "puerto_rico", R.drawable.puerto_rico)
        configurarBandera(R.id.flagItem6, "jamaica", R.drawable.jamaica)
        configurarBandera(R.id.flagItem7, "honduras", R.drawable.honduras)
        configurarBandera(R.id.flagItem8, "haiti", R.drawable.haiti)
        configurarBandera(R.id.flagItem9, "guatemala", R.drawable.guatemala)
        configurarBandera(R.id.flagItem10, "belice", R.drawable.belice)
        configurarBandera(R.id.flagItem11, "panama", R.drawable.panama)
        configurarBandera(R.id.flagItem12, "el_salvador", R.drawable.el_salvador)
        configurarBandera(R.id.flagItem13, "costa_rica", R.drawable.costa_rica)
