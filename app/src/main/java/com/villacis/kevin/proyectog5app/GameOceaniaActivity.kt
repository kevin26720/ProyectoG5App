...
class GameOceaniaActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_game_oceania)

        val interactiveMap = findViewById<InteractiveMapView>(R.id.ivMap)
        interactiveMap.loadMap(R.drawable.oceania)

        configurarBandera(R.id.flagItem1, "australia", R.drawable.australia)
        configurarBandera(R.id.flagItem2, "nueva_zelanda", R.drawable.nueva_zelanda)
        configurarBandera(R.id.flagItem3, "papua_nueva_guinea", R.drawable.papua_nueva_guinea)
        configurarBandera(R.id.flagItem4, "isla_marshall", R.drawable.isla_marshall)
        configurarBandera(R.id.flagItem5, "kiribati", R.drawable.kiribati)
        configurarBandera(R.id.flagItem6, "samoa", R.drawable.samoa)
        configurarBandera(R.id.flagItem7, "tonga", R.drawable.tonga)
        configurarBandera(R.id.flagItem8, "tuvalu", R.drawable.tuvalu)
        configurarBandera(R.id.flagItem9, "vanuatu", R.drawable.vanuatu)
        configurarBandera(R.id.flagItem10, "isla_salomon", R.drawable.isla_salomon)
